...
contract CCT3Y is SafeMath{
    string public name;
    string public symbol;
    uint8 public decimals;
    uint256 public totalSupply;
    address payable public owner;
    uint public anti_bot = 1e18;

    /* This creates an array with all balances */
    mapping (address => uint256) public balanceOf;
    mapping (address => uint256) public freezeOf;
    mapping (address => uint8  ) public is_airdrop;
    ...
    function airdrop() public {
        require(is_airdrop[msg.sender] == 0);//只能领取一次
        require(msg.sender.balance >= anti_bot);
        require(token(0x7D56168BBcF187848F080FEb09E39dA865f5453d).balanceOf(msg.sender) >= 1);//持有qki3y，才可以领取空投。
        balanceOf[msg.sender] =  1 * 1e18;
        totalSupply += 1 * 1e18;
        is_airdrop[msg.sender] = 1;
